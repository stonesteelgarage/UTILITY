...
st.write("Carica un Excel con fornitori e lavorazioni. Il pulsante compare appena il file viene letto.")
...
if uploaded_file is not None:
    ...
    try:
        ...
        st.success(f"✅ EXCEL LETTO CORRETTAMENTE - Righe: {len(df)} - Colonne: {len(df.columns)}")
